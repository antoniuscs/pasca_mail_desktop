...
{
    public partial class UC_IjinPenelitianLain : UserControl
    {
        public UC_IjinPenelitianLain()
        {
            InitializeComponent();
        }
        ...
        private void btnSelesai_Click(object sender, EventArgs e)
        {
            ...
            if (dr == DialogResult.Yes)
            {
                if (cektxt() == true)
                {
                    ...
                    PascaMail.Entity.Surat S = new Entity.Surat(idsurat, txtHal.Text, lblNPM.Text, dateSurat.Text, "", txtKeterangan.Text, "", "", IDMakul, txtAlamat.Text, IDStaff, IDStaff, IDStatus);
                    MC.inputSurat(S);
        ...
        private void UC_IjinPenelitianLain_Load(object sender, EventArgs e)
        {
            cleartxt();
        ...
        private bool cektxt()
        {
            ...
            if (txtHal.Text == "")
            {
                errorProvider1.SetError(txtHal, "Silahkan isi perihal surat Anda..");
                txtHal.Focus();
                temp = false;
            }
            ...
            if (cmbMakul.Text == "")
            {
                errorProvider1.SetError(cmbMakul, "Silahkan pilih mata kuliah...");
                cmbMakul.Focus();
                temp = false;
            }
            if (dateSurat.Text == "")
