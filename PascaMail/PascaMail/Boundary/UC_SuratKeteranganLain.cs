...
{
    public partial class UC_SuratKeteranganLain : UserControl
    {
        public UC_SuratKeteranganLain()
        {
            InitializeComponent();
        }
        ...
        private void UC_SuratKeteranganLain_Load(object sender, EventArgs e)
        {
            cleartxt();
        ...
        private bool cektxt()
        {
            ...
            if (txtAlamat.Text == "")
            {
                errorProvider1.SetError(txtAlamat, "Silahkan isi alamat surat...");
                txtAlamat.Focus();
                temp = false;
            }
            if (txtKeterangan.Text == "")
            {
                errorProvider1.SetError(txtKeterangan, "Silahkan isi keterangan surat...");
                txtKeterangan.Focus();
                temp = false;
            }
