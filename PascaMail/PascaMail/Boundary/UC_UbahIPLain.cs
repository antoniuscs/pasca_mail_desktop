...
{
    public partial class UC_UbahIPLain : UserControl
    {
        public UC_UbahIPLain()
        {
            InitializeComponent();
        }
        ...
        string temp = "";
        public void isiTextBox(string idSurat, string perihal, string tglMasuk, string makul, string tglAmbil, string npm, string alamat, string keterangan, string staffInput, string staffAmbil, string status, string id)
        {
        ...
        private void UC_UbahIPLain_Load(object sender, EventArgs e)
        {
